...
2. **Both public APIs are Maven-resolvable.** Default dependencies:
    - `io.humainary.substrates:humainary-substrates-api:3.0.0`
    - `io.humainary.serventis:humainary-serventis-api:3.0.0`
...
The suite defaults to Substrates API `3.0.0` and Serventis API `3.0.0`, as declared in
