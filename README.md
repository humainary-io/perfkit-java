...
2. **Both public APIs are Maven-resolvable.** Default dependencies:
    - `io.humainary.substrates:humainary-substrates-api:3.0.2`
    - `io.humainary.serventis:humainary-serventis-api:3.0.2`
...
The suite defaults to Substrates API `3.0.2` and Serventis API `3.0.2`, as declared in
