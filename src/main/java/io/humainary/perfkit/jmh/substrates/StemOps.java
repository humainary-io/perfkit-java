...
///    The circuit thread traverses the immutable `Inlet.parent` chain built
///    root-first during pipe lookup.
///
...
public class StemOps
  ...
  public void setupIteration () {
    ...
    // Drain subscription registration. Subscriber callbacks remain lazy until
    // the first warmup or measured emission.
    circuit.await ();
